...
Run: bench --site dine_matters execute dinematters.dinematters.tests.petpooja_live_test.run
...
def run():
    ...
    raw_url = get_url("/api/method/dinematters.dinematters.api.pos.petpooja_callback")
    ...
    if "localhost" in raw_url or "127.0.0.1" in raw_url:
        callback_url = "https://backend.dinematters.com/api/method/dinematters.dinematters.api.pos.petpooja_callback"
    ...
    payload = {
        ...
        "OrderInfo": {
            "customer": {
                "name": "DineMatters Test",
                "phone": "9999999999",
                "email": "test@dinematters.com",
            ...
            "order": {
                ...
                "discount_total": "0",
                "discount_type": "F",
                "description": "DineMatters sandbox live test order",
