...
import unittest
import frappe
from dinematters.dinematters.tests.utils import make_restaurant, cleanup_restaurant
...
class TestEvent(unittest.TestCase):
	...
	def test_upload_session_as_restaurant(self):
		...
		from dinematters.dinematters.media.api import request_upload_session
