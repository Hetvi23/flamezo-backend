# DineMatters: Unified Fee Structure & Marketing Audit (2026)

This document provides a definitive audit of the DineMatters platform's economics. It has been validated from a marketing perspective to ensure professional clarity and value-driven positioning for restaurant partners.

---

## 1. Subscription Tiers (Monthly Platform Access)
DineMatters offers three distinct tiers designed to grow with your restaurant.
...
- **Delivery Extra Handling Charge (₹5.00)**: DineMatters takes a flat ₹5 handling fee for every delivery processed through our integrated logistics partners (Borzo/Flash).
...
## 7. Marketing Optimizations (Implementation Checklist)
