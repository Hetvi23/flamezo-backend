...
import unittest
import json
from flamezo_backend.flamezo.api.google_business import generate_seo_slug, get_google_auth_url
...
class TestGoogleGrowth(unittest.TestCase):
    ...
    def test_menu_sync_payload(self):
        ...
        from flamezo_backend.flamezo.api.google_business import sync_menu_to_google
